...
holders = pd.read_csv('stock_holders.csv',encoding='gbk')
concept = pd.read_csv('concept.csv',encoding='gbk')
concept_details = pd.read_csv('concept_details.csv',encoding='gbk')
sh = pd.read_csv('sh.csv',encoding='gbk')
sz = pd.read_csv('sz.csv',encoding='gbk')
